...
class Store:
    ...
    def finish_success(self, job: dict[str, Any], output: dict[str, Any]) -> bool:
        return self._finish(job, "succeeded", None, output)

    def finish_retryable(self, job: dict[str, Any], message: str) -> bool:
        return self._finish(job, "pending", message, None)

    def finish_terminal(self, job: dict[str, Any], message: str) -> bool:
        return self._finish(job, "failed", message, None)
