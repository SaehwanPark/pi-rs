---
name: rupi-invariant-reviewer
description: Review rupi plans and diffs for violations of runtime, provenance, failover, compatibility, security, and startup invariants.
---

# rupi Invariant Reviewer
