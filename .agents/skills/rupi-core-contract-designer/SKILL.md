---
name: rupi-core-contract-designer
description: Design and implement rupi runtime contracts with typed state, explicit provenance, deterministic events, and testable failure semantics.
---

# rupi Core Contract Designer
