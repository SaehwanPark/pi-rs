...
use pi_rs_core::{
  ...
  ExternalizedField, ModelCapabilities, ModelEndpoint, ModelRef, ReasoningExposure,
  ReasoningProvenance, RuntimeConfig, SessionEndReason, SessionEnded, SessionId, SessionStarted,
  ToolCallId, ToolCompleted, ToolExecutionState, ToolFailed, ToolRequested, ToolStarted,
  TraceEntry, UserMessage,
};
