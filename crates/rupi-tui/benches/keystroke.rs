...
//!
//! Why this exists: the editor is the part of `rupi` that has to keep up with a finger, and
...
//!
//! Run: `cargo bench -p rupi-tui --bench keystroke`, or `bash bench/keystroke.sh`.
...
/// `cargo bench -p rupi-tui --bench keystroke` at the default 200 iterations, medians stable to
