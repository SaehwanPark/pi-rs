//! `rupi-mcp` — MCP (Model Context Protocol) client for `rupi`.
//!
//! This crate implements the MCP client subsystem for `rupi`, providing:
...
//! - Tool normalization into the standard [`rupi_core::tool::Tool`] abstraction.
