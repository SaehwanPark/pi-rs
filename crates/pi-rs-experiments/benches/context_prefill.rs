...
//!
//! Run: `cargo bench -p pi-rs-experiments --bench context_prefill`
//! Or:  `bench/context_prefill.sh [--iterations <N>] [--json <path>]`

use std::{env, fs, process::ExitCode, time::Instant};

use pi_rs_core::context::{ContextPolicy, ContextProfile, ContextState};
use pi_rs_experiments::{
...
fn main() -> ExitCode {
  ...
  println!("Context prefill and optimization benchmarks (pi-rs-experiments):");
