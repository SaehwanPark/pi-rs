"""Command-line entry point for the Artifact Pipeline service and worker."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="signed HTTP intake and bounded local pipeline worker")
